...
if ( ! function_exists( 'ere_get_property_price' ) ) {
	 ...
	 * @return string
	 */
	function ere_get_property_price( $property_id = 0, $show_old_price = false ) {
...
if ( ! function_exists( 'ere_property_price' ) ) {
	 ...
	 * @param bool $show_old_price
	 */
	function ere_property_price( $property_id = 0, $show_old_price = false ) {
		echo ere_get_property_price( $property_id, $show_old_price );
	}
}
