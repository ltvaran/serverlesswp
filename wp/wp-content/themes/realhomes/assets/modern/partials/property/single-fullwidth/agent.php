                            ...
                            <div class="contacts-list">
                                ...
                                <div class="rh_agent_profile__social social-networks-brand-color">
									...
									if ( ! empty( $facebook_url ) ) : ?>
                                        <a class="facebook" target="_blank" href="<?php echo esc_url( $facebook_url ); ?>"><i class="fab fa-facebook"></i></a>
									<?php
									endif;

									if ( ! empty( $twitter_url ) ) : ?>
                                        <a class="twitter" target="_blank" href="<?php echo esc_url( $twitter_url ); ?>"><i class="fab fa-twitter"></i></a>
									<?php
									endif;

									if ( ! empty( $linked_in_url ) ) : ?>
                                        <a class="linkedin" target="_blank" href="<?php echo esc_url( $linked_in_url ); ?>"><i class="fab fa-linkedin"></i></a>
									<?php
									endif;

									if ( ! empty( $instagram_url ) ) : ?>
                                        <a class="instagram" target="_blank" href="<?php echo esc_url( $instagram_url ); ?>"><i class="fab fa-instagram"></i></a>
									<?php endif;

									if ( ! empty( $agent_website ) ) : ?>
                                        <a class="website-icon" target="_blank" href="<?php echo esc_url( $agent_website ); ?>"><i class="fas fa-globe"></i></a>
									<?php
									endif;

									if ( ! empty( $youtube_url ) ) : ?>
                                        <a class="youtube" target="_blank" href="<?php echo esc_url( $youtube_url ); ?>"><i class="fab fa-youtube-square"></i></a>
									<?php
									endif;

									if ( ! empty( $pinterest_url ) ) : ?>
                                        <a class="pinterest" target="_blank" href="<?php echo esc_url( $pinterest_url ); ?>"><i class="fab fa-pinterest"></i></a>
									<?php
									endif;
									?>
                    ...
                    <div class="rh_property__agent_detail_right_col">
                        <div class="rh_property__agent_contact rh_agent_form">
                            ...
                            elseif ( isset( $args['agent_email'] ) && ! empty( $args['agent_email'] ) ) :
								...
								?>
                                <form id="<?php echo esc_attr( $agent_form_id ); ?>"
