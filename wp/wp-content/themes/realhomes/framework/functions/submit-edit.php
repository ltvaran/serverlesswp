                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="inspiry-field">
                                ...
                                <input type="text" id="inspiry_floor_plan_price_postfix_<?php echo esc_attr( $index ); ?>" name="inspiry_floor_plans[<?php echo esc_attr( $index ); ?>][inspiry_floor_plan_price_postfix]" value="<?php echo esc_attr( $floor_plan['inspiry_floor_plan_price_postfix'] ); ?>">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="inspiry-field">
