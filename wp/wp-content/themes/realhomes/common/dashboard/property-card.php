...
<div class="property-column-wrap">
    ...
    <div class="small-column-wrap">
		...
		if ( ! empty( $isp_settings['enable_stripe'] ) || ! empty( $rpp_settings['enable_paypal'] ) ) {
			...
			} elseif ( ! empty( $rpp_settings['enable_paypal'] ) && ! empty( $rpp_settings['payment_amount'] ) && ! empty( $rpp_settings['currency_code'] ) ) {
        ...
        <div class="column column-price">
            ...
            <div class="property-payment-info"><?php
				...
				} elseif ( ! class_exists( 'IMS_Functions' ) && $individual_payment_enabled ) {
