	...
	public function register_shortcode($shortcodeName) {
		function shortcode_video($atts, $content = null) {
            ...
            if ($is_vimeo > 0) {
                ...
                $compile .= "
            <iframe src=\"https://player.vimeo.com/video/" . $videoid . "\" width=\"{$w}\" height=\"{$h}\" frameborder=\"0\" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
        ";
            }
...
<table>
	...
	<tr>
		...
		<td><input value='' type='text' class='".$shortcodeName."_video' name='".$shortcodeName."_video'><br />
			...
			".__('Youtube','theme_localization')." - https://www.youtube.com/watch?v=6v2L2UGZJAM<br />
			".__('Vimeo','theme_localization')." - https://vimeo.com/47989207</div>
		</td>
	</tr>
	<tr>
		<td>Float:</td>
