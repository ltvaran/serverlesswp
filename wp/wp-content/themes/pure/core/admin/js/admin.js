...
jQuery(function ($) {
    ...
    // ajax button
    $('.admin_mix_ajax_button').on('click', function () {
    ...
    jQuery(document).on('change', '.editor-post-format select', function () {
        ...
        var gt3_guten_clickformat = this.value;
        switch (gt3_guten_clickformat) {
            case 'image':
    ...
    /* WP >=3.6 */
    $('.post-format-options a').on('click', function () {
        $('#portslides_sectionid_inner, #audio_sectionid_inner, #video_sectionid_inner, #default_sectionid_inner').hide();
    ...
    if (jQuery('.components-select-control__input').length) {
        jQuery('.components-select-control__input').on("change", function () {
            ...
            jQuery('.post-formats-container > div').hide()
    ...
    setTimeout(function () {
        //console.log(jQuery('.editor-post-format select'))
        if (jQuery('.editor-post-format select').length) {
            var gt3_guten_post_format = jQuery('.editor-post-format select')[0];
            var nowpostformat = gt3_guten_post_format.value;
            console.log(nowpostformat);

            if (nowpostformat == 'image' || nowNEWpostformat == 'image') {
                $('#portslides_sectionid_inner').show();
            } else if (nowpostformat == 'audio') {
                $('#audio_sectionid_inner').show();
    ...
    $(document).ready(function () {
		$('.custom_select_img_preview').on('click', function(){
...
jQuery("document").ready(function($) {
    $(".admin_page_settings .admin_save_all").on('click', function() {
    ...
    $(".admin_page_settings .admin_reset_settings").on('click', function() {
        var agree = confirm("Are you sure?");
        if (!agree)
            return false;
        $("#wpwrap").css("opacity", "0.5");
    ...
    $(".add-new-strip").on('click', function(){
        var data = {
...
function add_menu_item() {
	$('.field-css-classes').each(function(){
		if($(this).find('.show_menu_icon').length) {} else {
