...
class flickr extends WP_Widget {
	...
	function widget( $args, $instance ) {
        ...
        echo '<div class="flickr_widget_wrapper"><script src="https://www.flickr.com/badge_code_v2.gne?count='.$instance['flickr_widget_number'].'&display=latest&size=s&layout=x&source=user&user='.$instance['flickr_widget_id'].'"></script></div>';
